...
public class CommandParserTest {
    ...
    public void helpShouldShowInfoAboutAllCommands() {
        ...
        verify(messageController).showSystemMessage(
                "VertoChat commands:\n" +
                        "/about - information about VertoChat\n" +
    ...
    public void transfersShouldShowSystemMessageWithMultipleActiveSenders() {
        ...
        final FileSender fileSender2 = createFileSender(2, "verto.png", 10L, 80, 5L, "Donald");
        ...
        verify(messageController).showSystemMessage("File transfers:\n" +
                ...
                "  #2 verto.png [10.00KB] (80%, 5.00KB/s) to Donald\n" +
    ...
    public void transfersShouldShowSystemMessageWithMultipleActiveReceivers() {
        ...
        final FileReceiver fileReceiver2 = createFileReceiver(2, "verto.png", 10L, 80, 5L, "Donald");
        ...
        verify(messageController).showSystemMessage("File transfers:\n" +
                ...
                "  #2 verto.png [10.00KB] (80%, 5.00KB/s) from Donald\n" +
