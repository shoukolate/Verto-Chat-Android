...
public class NotificationService {
    ...
    private final org.dynamicsoft.VertoChat.android.notification.FileTransferNotificationService fileTransferNotificationService;
    ...
    public NotificationService(final Context context, final AndroidSettings settings) {
        ...
        fileTransferNotificationService = new org.dynamicsoft.VertoChat.android.notification.FileTransferNotificationService(context, notificationManager, settings);
