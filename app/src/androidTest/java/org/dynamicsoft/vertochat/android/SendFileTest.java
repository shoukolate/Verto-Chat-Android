...
import org.dynamicsoft.vertochat.android.controller.SendFileController;
 ...
 * The image vertochat-1600x1600.png will be added to the gallery if it's missing.
 *
...
public class SendFileTest extends ActivityInstrumentationTestCase2<SendFileController> {
    ...
    public void test01NoSelectedFile() {
        ...
        if (imageWithContentUri == null) {
            FileUtils.copyVertoChatImageFromAssetsToSdCard(instrumentation, activity);
            imageWithContentUri = FileUtils.getVertoChatImageFromSdCardWithContentUri(activity);
            imageWithFileUri = FileUtils.getVertoChatImageFromSdCardWithFileUri();
        }
