...
public class ManualReceiveFileTest extends ActivityInstrumentationTestCase2<MainChatController> {
    ...
    public void test01AcceptFileTransferRequestWithoutStorage() {
        ...
        checkMainChatMessage("*** Kenny is trying to send the file vertochat-1600x1600.png");
        ...
        checkDialogMessage("Kenny is trying to send you the file ‘vertochat-1600x1600.png’ (67.16KB). " +
        ...
        checkMainChatMessage("*** Failed to receive vertochat-1600x1600.png from Kenny");
        checkThatNoFileTransferNotificationsAreActive();
        checkThatTheFileHasNotBeenTransferred();
    }
