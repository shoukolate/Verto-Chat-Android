...
public class ReceiveFileTest extends ActivityInstrumentationTestCase2<MainChatController> {
    ...
    public void setUp() {
        ...
        if (albert == null) {
            ...
            FileUtils.copyVertoChatImageFromAssetsToSdCard(instrumentation, mainChatController);
            image = FileUtils.getVertoChatImageFromSdCardWithContentUri(mainChatController);
    ...
    public void test02RejectFileTransferRequest() {
        ...
        checkMainChatMessage("*** Tina is trying to send the file vertochat-1600x1600.png");
        ...
        checkThatTheDialogIsInFront();
        checkDialogMessage("Tina is trying to send you the file ‘vertochat-1600x1600.png’ (67.16KB). " +
        ...
        checkThatTheMainChatIsInFront();
        checkMainChatMessage("*** You declined to receive vertochat-1600x1600.png from Tina");
        checkThatNoFileTransferNotificationsAreActive();
        checkThatTheFilesHaveNotBeenTransferred();
    }
    ...
    public void test03AcceptFileTransferRequest() throws IOException {
        ...
        checkMainChatMessage("*** Albert is trying to send the file vertochat-1600x1600.png");
        ...
        checkThatTheDialogIsInFront();
        checkDialogMessage("Albert is trying to send you the file ‘vertochat-1600x1600.png’ (67.16KB). " +
                "Do you want to accept the file transfer?");
        solo.sleep(500);
        ...
        checkThatTheMainChatIsInFront();
        checkMainChatMessage("*** Receiving vertochat-1600x1600.png from Albert");
        checkMainChatMessage("*** Successfully received vertochat-1600x1600.png from Albert, and saved as vertochat-1600x1600.png");
        checkThatNoFileTransferNotificationsAreActive();
    ...
    public void test04CancelFileTransferRequestBeforeOpeningActivity() {
        ...
        checkMainChatMessage("*** Xen is trying to send the file vertochat-1600x1600.png");
        ...
        solo.sleep(1000);
        checkMainChatMessage("*** Xen aborted sending of vertochat-1600x1600.png");
        checkThatNoFileTransferNotificationsAreActive();
        checkThatTheFilesHaveNotBeenTransferred();
    }
    ...
    public void test05CancelFileTransferRequestBeforeRejecting() {
        ...
        checkMainChatMessage("*** XenMaster is trying to send the file vertochat-1600x1600.png");
        ...
        checkThatTheDialogIsInFront();
        checkDialogMessage("XenMaster is trying to send you the file ‘vertochat-1600x1600.png’ (67.16KB). " +
                "Do you want to accept the file transfer?");
        solo.sleep(500);
        ...
        checkThatTheMainChatIsInFront();
        checkMainChatMessage("*** XenMaster aborted sending of vertochat-1600x1600.png");
        checkThatNoFileTransferNotificationsAreActive();
        checkThatTheFilesHaveNotBeenTransferred();
    }
    ...
    public void test06CancelFileTransferRequestBeforeAccepting() {
        ...
        checkMainChatMessage("*** SuperTina is trying to send the file vertochat-1600x1600.png");
        ...
        checkThatTheDialogIsInFront();
        checkDialogMessage("SuperTina is trying to send you the file ‘vertochat-1600x1600.png’ (67.16KB). " +
                "Do you want to accept the file transfer?");
        solo.sleep(500);
        ...
        checkThatTheMainChatIsInFront();
        checkMainChatMessage("*** SuperTina aborted sending of vertochat-1600x1600.png");
        checkThatNoFileTransferNotificationsAreActive();
        checkThatTheFilesHaveNotBeenTransferred();
    }
    ...
    public void test07CloseAndReopenDialog() {
        ...
        checkMainChatMessage("*** Alban is trying to send the file vertochat-1600x1600.png");
        ...
        checkThatTheDialogIsInFront();
        checkDialogMessage("Alban is trying to send you the file ‘vertochat-1600x1600.png’ (67.16KB). " +
                "Do you want to accept the file transfer?");
        solo.sleep(500);
        ...
        checkThatTheMainChatIsInFront();
        checkMainChatMessage("*** You declined to receive vertochat-1600x1600.png from Alban");
        checkThatNoFileTransferNotificationsAreActive();
        checkThatTheFilesHaveNotBeenTransferred();
    }
    ...
    public void test08ConcurrentFileTransfers() throws IOException {
        ...
        checkMainChatMessage("*** Albino is trying to send the file vertochat-1600x1600.png");
        checkMainChatMessage("*** TinaBurger is trying to send the file vertochat-1600x1600.png");
        checkMainChatMessage("*** XenXei is trying to send the file vertochat-1600x1600.png");
        ...
        checkPastMainChatMessage("*** Receiving vertochat-1600x1600.png from Albino");
        checkPastMainChatMessage("*** Successfully received vertochat-1600x1600.png from Albino, and saved as vertochat-1600x1600.png");

        checkPastMainChatMessage("*** Receiving vertochat-1600x1600.png from XenXei");
        checkPastMainChatMessage("*** Successfully received vertochat-1600x1600.png from XenXei, and saved as vertochat-1600x1600_1.png");

        checkMainChatMessage("*** Receiving vertochat-1600x1600.png from TinaBurger");
        checkMainChatMessage("*** Successfully received vertochat-1600x1600.png from TinaBurger, and saved as vertochat-1600x1600_2.png");
    ...
    public void test09UserLoggingOffShouldCancelFileTransferRequest() {
        ...
        checkMainChatMessage("*** TinaTurner is trying to send the file vertochat-1600x1600.png");
