...
/**
 * Test that sends a file transfer request and waits. Useful when necessary to agree to
 * write permissions before the normal tests will run.
 *
 * @author Christian Ihle
 */
public class ManualWritePermissionTest extends ActivityInstrumentationTestCase2<MainChatController> {
    ...
    public ManualWritePermissionTest() {
    ...
    public void test01AcceptPermissionManually() {
