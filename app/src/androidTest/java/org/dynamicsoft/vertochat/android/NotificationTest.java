...
public class NotificationTest extends ActivityInstrumentationTestCase2<MainChatController> {
    ...
    public void test01ShouldShowNotificationWhenVertoChatIsHiddenAndSomeoneWritesInTheMainChat() {
        solo.sleep(1500);
    ...
    public void test02ShouldShowNotificationWhenVertoChatIsHiddenAndSomeoneWritesInThePrivateChat() {
        solo.sleep(1500);
        assertNoNotifications();
