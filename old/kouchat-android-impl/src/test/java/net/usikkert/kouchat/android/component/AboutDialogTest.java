...
public class AboutDialogTest {
    ...
    public void dialogTitleShouldBeApplicationNameAndVersion() {
        assertEquals("VertoChat v" + Constants.APP_VERSION, shadowDialog.getTitle());
    }
    ...
    public void dialogShouldHaveUrlAndMailToLinks() {
        ...
        assertEquals("mailto:contact@vertochat.net", urls[0].getURL());
        assertEquals("http://www.vertochat.net", urls[1].getURL());
