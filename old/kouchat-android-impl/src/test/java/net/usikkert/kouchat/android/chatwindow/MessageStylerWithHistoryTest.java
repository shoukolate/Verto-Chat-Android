...
import org.dynamicsoft.vertochat.android.component.DefaultLineHeightSpan;
...
public class MessageStylerWithHistoryTest {
    ...
    public void styleAndAppendShouldAddLinks() {
        final CharSequence message = messageStyler.styleAndAppend("http://vertochat.googlecode.com/", 0);
    ...
    public void getHistoryShouldRememberLinks() {
        messageStyler.styleAndAppend("http://vertochat.googlecode.com/", 0);
    ...
    private void checkLinks(final SpannableStringBuilder builder) {
        ...
        assertNotNull(spans);
        assertEquals(1, spans.length);
        assertEquals("http://vertochat.googlecode.com/", spans[0].getURL());
    }
