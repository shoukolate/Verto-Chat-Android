...
public class RobotiumTestUtilsTest {
    ...
    public void getMatchingLinesOfTextShouldFindCorrectLinesWhenBetweenOtherLines() {
        final List<Line> lines = RobotiumTestUtils.getMatchingLinesOfText(
                "something http://vertochat.googlecode.com here",
                Arrays.asList(
                        "something ",
                        "http://",
                        "vertochat.googlecode",
                        ".com",
                        " here"),
                "http://vertochat.googlecode.com");

        assertEquals(3, lines.size());

        correctLineContent(lines.get(0), 1, "http://");
        correctLineContent(lines.get(1), 2, "vertochat.googlecode");
    ...
    public void getMatchingLinesOfTextShouldThrowExceptionIfAllWordsAreThereButInWrongOrder() {
        ...
        expectedException.expectMessage("Could not find: http://vertochat.googlecode.com");

        RobotiumTestUtils.getMatchingLinesOfText(
                "http://googlecode.vertochat.com",
                Arrays.asList(
                        "http://",
                        "googlecode.vertochat",
                        ".com"),
                "http://vertochat.googlecode.com");
    }
    ...
    public void getMatchingLinesOfTextShouldThrowExceptionIfAllWordsAreThereButExtraWordInTheMiddle() {
        ...
        RobotiumTestUtils.getMatchingLinesOfText(
                "http://vertochat.googlecode something .com",
                Arrays.asList(
                        "http://",
                        "vertochat.googlecode",
                        " something ",
    ...
    public void getMatchingLinesOfTextShouldFindTheLinesInSequence() {
        final List<Line> lines = RobotiumTestUtils.getMatchingLinesOfText(
                "http://vertochat.googlecode http://vertochat.googlecode.com",
                Arrays.asList(
                        "http://",
                        "vertochat.googlecode ",
                        "http://",
        ...
        correctLineContent(lines.get(1), 3, "vertochat.googlecode"); // Not line 1
    ...
    public void getMatchingLinesOfTextShouldFindTheLastOccurrence() {
        final List<Line> lines = RobotiumTestUtils.getMatchingLinesOfText(
                "http://vertochat.googlecode.com http://vertochat.googlecode.com",
                Arrays.asList(
                        "http://",
                        "vertochat.googlecode",
                        ".com ",
        ...
        correctLineContent(lines.get(1), 4, "vertochat.googlecode");
    ...
    public void getMatchingLinesOfTextShouldFindCorrectLinesWhenFirstAndLastLinesHaveExtraText() {
        final List<Line> lines = RobotiumTestUtils.getMatchingLinesOfText(
                "[17:02:41] *** Tina aborted reception of vertochat-512x512.png ***",
                Arrays.asList(
                        "[17:02:41] *** Tina aborted ",
                        "reception of ",
                        "vertochat-512x512.png ***"),
                "Tina aborted reception of vertochat-512x512.png");

        assertEquals(3, lines.size());

        correctLineContent(lines.get(0), 0, "Tina aborted ");
        correctLineContent(lines.get(1), 1, "reception of ");
        correctLineContent(lines.get(2), 2, "vertochat-512x512.png");
    }

    @Test
    public void getMatchingLinesOfTextShouldFindCorrectLinesEvenWhenSpreadOverManyLines() {
        final List<Line> lines = RobotiumTestUtils.getMatchingLinesOfText(
                "[18:47:32] *** Tina aborted reception of vertochat-512x512.png ***",
                Arrays.asList(
                        "[18:47:32] *** ",
                        "Tina ",
                        "aborted",
        ...
        correctLineContent(lines.get(4), 5, "vertochat");
    ...
    public void getMatchingLinesOfTextShouldFindCorrectLineWhenAllOnOneLine() {
        final List<Line> lines = RobotiumTestUtils.getMatchingLinesOfText(
                "Tina aborted reception of vertochat-512x512.png",
                Arrays.asList("Tina aborted reception of vertochat-512x512.png"),
                "Tina aborted reception of vertochat-512x512.png");

        assertEquals(1, lines.size());

        correctLineContent(lines.get(0), 0, "Tina aborted reception of vertochat-512x512.png");
    }
    ...
    public void getMatchingLinesOfTextShouldFindCorrectLineWhenAllOnOneLineWithExtraTextBeforeAndAfter() {
        final List<Line> lines = RobotiumTestUtils.getMatchingLinesOfText(
                "[17:02:41] *** Tina aborted reception of vertochat-512x512.png ***",
                Arrays.asList("[17:02:41] *** Tina aborted reception of vertochat-512x512.png ***"),
                "Tina aborted reception of vertochat-512x512.png");
    ...
    public void getMatchingLinesOfTextShouldThrowExceptionIfAWordIsMissingOnTheSameLine() {
        expectedException.expect(IllegalArgumentException.class);
        expectedException.expectMessage("Could not find: Tina aborted reception of vertochat-512x512.png");

        RobotiumTestUtils.getMatchingLinesOfText(
                "Tina aborted reception of vertochat-512x512",
                Arrays.asList("Tina aborted reception of vertochat-512x512"),
                "Tina aborted reception of vertochat-512x512.png");
    }
